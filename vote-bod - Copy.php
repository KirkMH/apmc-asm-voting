...
<div id="myModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form id="upload_id" name="upload_id" action="upload-and-save.php" method="post" enctype="multipart/form-data" >
...
<div class="fullcontainer">
	...
	<form method="post" id="voting_form" action="vote-bod.php">
  ...
  <div id="top" align="center"> <span class="h1w">Election of Board of Directors</span><br>
	  <div id="q0" class="toggleDiv" style="display: block;" align="center">
	    <div id="box"> <span style="color:red"><b>Instructions</b></span>
	        ...
	        You can give up to <?=$_SESSION['points']?> shares to any candidate of your choice. To give your share(s) to a candidate, simply click <kbd style="background-color: #17a2b8;">+</kbd> button to add shares, or <kbd style="background-color: #6c757d;">-</kbd> to reduce it. You may also directly enter the number of shares that you want to give to the candidate. The system will notify you if you exceed the maximum selection.<br><br></p>
   ...
   $('.show_hide').showHide({			 
	...
	$('.vote').on("keyup", function() {
		...
		if (cdt == 16) {
			...
			$('#prompt_text').html("Sorry, the assigned share will exceed your maximum number of shares. Please check your remaining shares on the right panel. You may still adjust your shares by deducting some from other candidates.");
			$("#myPrompt").modal('show');
			$(this).val(0);
			update_selected();
		}
