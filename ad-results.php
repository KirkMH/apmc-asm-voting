...
<div class="fullcontainer" style="text-align: left; padding-top: 90px;">
  ...
  <div class="card" style="margin-top: 30px;">
    <div class="card-header bg-success">
      <div>
          <h3 class="float-center" style="color: white;">BOD Election Results</h3>
    ...
    <div class="card-body">
        ...
        <thead>
            <tr>
                <th class="c">L/N</th>
                <th>Candidate</th>
                <th class="c">Number of Votes</th>
            </tr>
        </thead>
        <tbody>
        	<?php
          $ctr = 0;
			$all = MyDb::select_all("*", "results", "1 ORDER BY total_votes DESC, display_name ASC");
          ...
          $ctr++;
            ...
            <tr>
                ...
                <td class="c"><a href="#bannerformmodal" data-toggle="modal" data-target="#bannerformmodal" title="View details" class="view_detail" data-pid="<?=$value['candidate_id']?>"><?=$value['total_votes'];?></a></td>
            </tr>
        	<?php
        		} 
        	} ?>
