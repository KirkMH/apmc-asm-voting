...
<div class="sticky-container">
    <div class="card">
	  ...
	  <div class="card-body">
		<p class="card-text" id="rem_cand" style="font-size:21pt; text-align: center;">15</p>
	  </div>
	</div>
</div>
